...
<tileset version="1.4" tiledversion="1.4.3" name="burgerbread" tilewidth="32" tileheight="32" tilecount="110" columns="11">
 <properties>
...
(c1) Allow the user of the Media Product to extract the Licensed Asset or Derivative Works and use them outside of the relevant Media Product.</property>
 ...
 <image source="../ss13-icons/obj/food/burgerbread.png" width="352" height="320"/>
 <tile id="99">
  <animation>
