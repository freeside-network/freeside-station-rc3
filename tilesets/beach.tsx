...
<tileset version="1.4" tiledversion="1.4.2" name="beach" tilewidth="32" tileheight="32" tilecount="256" columns="16">
 <properties>
  <property name="tilesetCopyright">You can use the Licensed Asset to create Derivative Works; and
...
(c1) Allow the user of the Media Product to extract the Licensed Asset or Derivative Works and use them outside of the relevant Media Product.</property>
 </properties>
 <image source="../ss13-icons/misc/beach.png" width="512" height="512"/>
 <terraintypes>
  <terrain name="sand" tile="0"/>
  <terrain name="water" tile="6"/>
 </terraintypes>
 ...
 <tile id="100" terrain="1,0,1,0"/>
 <tile id="101" terrain="0,1,1,1"/>
 <tile id="102" terrain="1,0,1,1"/>
 ...
 <tile id="196" terrain="0,0,1,0"/>
 <tile id="197" terrain="0,0,0,1"/>
</tileset>
