...
<tileset version="1.4" tiledversion="1.4.2" name="RAM (Random Access Memory)" tilewidth="32" tileheight="32" tilecount="1" columns="1">
 <properties>
...
(c1) Allow the user of the Media Product to extract the Licensed Asset or Derivative Works and use them outside of the relevant Media Product.</property>
 ...
 <image source="../oc-tiles/RAM (Random Access Memory).png" width="32" height="32"/>
</tileset>
