...
<tileset version="1.4" tiledversion="1.4.3" name="floppy_special" tilewidth="32" tileheight="32" tilecount="9" columns="3">
 <properties>
...
(c1) Allow the user of the Media Product to extract the Licensed Asset or Derivative Works and use them outside of the relevant Media Product.</property>
 ...
 <image source="../oc-tiles/floppy_special.png" width="96" height="96"/>
 <tile id="0">
  <animation>
